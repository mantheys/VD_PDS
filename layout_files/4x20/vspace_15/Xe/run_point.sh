...
ifdh cp -D /pnfs/dune/scratch/users/smanthey/vdriftXe/vspace/4x20/vspace_15/vdriftXe4x20_vspace_15_tar.tgz ./
tar -xzvf vdriftXe4x20_vspace_15_tar.tgz
...
eval "$(echo "ifdh cp -D arapuca_${1}_${2}_${3}.root /pnfs/dune/scratch/users/smanthey/vdriftXe/vspace/4x20/vspace_15/.")"
