...
ifdh cp -D /pnfs/dune/scratch/users/smanthey/vdriftXe/buffer/4x20/buffer_45/vdriftXe4x20_buffer_45_tar.tgz ./
tar -xzvf vdriftXe4x20_buffer_45_tar.tgz
...
eval "$(echo "ifdh cp -D arapuca_${1}_${2}_${3}.root /pnfs/dune/scratch/users/smanthey/vdriftXe/buffer/4x20/buffer_45/.")"
