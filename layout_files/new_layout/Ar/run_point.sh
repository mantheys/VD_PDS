...
ifdh cp -D /pnfs/dune/scratch/users/smanthey/vdriftAr/new_layout/3x29/vdriftAr3x29_tar.tgz ./
tar -xzvf vdriftAr3x29_tar.tgz
...
eval "$(echo "ifdh cp -D arapuca_${1}_${2}_${3}.root /pnfs/dune/scratch/users/smanthey/vdriftAr/new_layout/3x29/.")"
