...
ifdh cp -D /pnfs/dune/scratch/users/smanthey/vdriftXe/layouts/new_4x20/vdriftXe4x20_tar.tgz ./
tar -xzvf vdriftXe4x20_tar.tgz
chmod u+x vdrift_build/g4workshop


./vdrift_build/g4workshop $1 $2 $3
mv -- "arapuca"* "arapuca_${1}_${2}_${3}.root"
eval "$(echo "ifdh cp -D arapuca_${1}_${2}_${3}.root /pnfs/dune/scratch/users/smanthey/vdriftXe/layouts/new_4x20/data")"