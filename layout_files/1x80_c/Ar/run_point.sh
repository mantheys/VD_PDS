...
ifdh cp -D /pnfs/dune/scratch/users/smanthey/vdriftAr/layouts/1x80_c/vdriftAr1x80_c_tar.tgz ./
tar -xzvf vdriftAr1x80_c_tar.tgz
...
eval "$(echo "ifdh cp -D arapuca_${1}_${2}_${3}.root /pnfs/dune/scratch/users/smanthey/vdriftAr/layouts/1x80_c/.")"
