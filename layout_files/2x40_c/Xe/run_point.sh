...
ifdh cp -D /pnfs/dune/scratch/users/smanthey/vdriftXe/layouts/2x40_c/vdriftXe2x40_c_tar.tgz ./
tar -xzvf vdriftXe2x40_c_tar.tgz
...
eval "$(echo "ifdh cp -D arapuca_${1}_${2}_${3}.root /pnfs/dune/scratch/users/smanthey/vdriftXe/layouts/2x40_c/.")"
